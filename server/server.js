...
const express = require("express"),
  ...
  eg014 = require("./lib/eg014CollectPayment"),
  eg005 = require("./lib/eg005EnvelopeRecipients"),
...
let app = express()
  ...
  .get(
    ...
    function(req, res) {
      ...
      var encry = symCrypt.symEncrypt(
        String(req.user.accessToken),
        dsConfig.dsClientSecret
      );
      res.redirect("http://localhost:5000/?t=" + encry);
    }
  ...
  .post("/createpayment", eg014.createController)
  .post("/checkenvelope", eg005.createController);
